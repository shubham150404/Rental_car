            ...
            <div>
                ...
                <div className='cadf2'>
                    <div className='container'>
                        ...
                        <h4 className='text-center'>SUPER CAR <span className='text-danger bold'>SUMMARY</span></h4>
                                ...
                                return (
                                    <>
                                        <div className='p-3 col-3 '>
                                            <div className="card_cars cadf" key={_id}>
                                                <img src={`http://localhost:3000/images/${photos}`} className="img-fluid img pb-3" alt="..." />
                                                <div className="card-body">
                                                    <h5 className='text-center'>{name}</h5>
                                                    <h6 className='text-center '>{price}</h6>
                                                    <div className='d-flex justify-content-between'>
                                                        <p className=" text-secondary ps-3 mb-0 pb-0">Vehicle Type</p>
                                                        <p className=" text-secondary pe-3 mb-0 pb-0">FUEL TYPE</p>
                                                    </div>
                                                    <div className='d-flex justify-content-between'>
                                                        <p className=" text-danger ps-3">{Vehicle_Type}</p>
                                                        <p className=" text-danger pe-3">{Engine}CC</p>
                                                    </div>
...
export default Super_car_details
