            ...
            <div>
                ...
                <div className='cadf2'>
                    <div className='container'>
                        ...
                        <h4 className='text-center'>SEDAN CAR <span className='text-danger bold'>SUMMARY</span></h4>
...
export default Varius_car_details
