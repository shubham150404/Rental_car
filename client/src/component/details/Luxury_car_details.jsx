            ...
            <div>
                ...
                <div className='cadf2'>
                    <div className='container'>
                        ...
                        <h4 className='text-center'>LUXURY CAR <span className='text-danger bold'>SUMMARY</span></h4>
...
export default Luxury_car_details
