            ...
            <div>
                ...
                <div className='cadf2'>
                    <div className='container'>
                        ...
                        <h4 className='text-center'>OFFROADING CAR <span className='text-danger bold'>SUMMARY</span></h4>
...
export default Offroad_car_details
