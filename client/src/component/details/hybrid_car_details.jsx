...
function Hybrid_car_details() {
    ...
    let filtered = datas.filter((cur) => {
        return cur.Vehicle_Type == 'hybrid'
    })
    console.log(datas);
            ...
            <div>
                ...
                <div className='cadf2'>
                    <div className='container'>
                        ...
                        <h4 className='text-center'>HYBRID CAR <span className='text-danger bold'>SUMMARY</span></h4>
...
export default Hybrid_car_details
