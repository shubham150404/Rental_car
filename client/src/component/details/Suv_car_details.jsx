            ...
            <div>
                ...
                <div className='cadf2'>
                    <div className='container'>
                        ...
                        <h4 className='text-center'>SUV CAR <span className='text-danger bold'>SUMMARY</span></h4>
...
export default Suv_car_details
