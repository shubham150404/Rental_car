...
import Buy_car_saidbar from './buy_car_saidbar.jsx'
...
function Car_details() {
    ...
    useEffect(() => {
        const singledata = () => {
            axios.get(`http://localhost:3000/new_car_findid/${id}`)
            .then((res) => {
                console.log(res);
            ...
            <div className="details_pages" >
                ...
                <div className="details_body">
                    <div className="det_header ">
                        {iserror != "" ? <span></span> :
                            <img src={`http://localhost:3000/images/${data.photos}`} alt="" className='img-fluid ' />
                        }
                    </div>
                            ...
                            <>
                                <div className="cars_card_body">
                                    <div className="row pt-5">
                                        {/* company name */}
                                        <div className="col-2">
                                            <div className="card_body_icon border  ">
                                                <div className="pt-5  d-flex justify-content-center ">
                                                    <div className="img_set  d-flex justify-content-center   ">
                                                        <img src={cars} alt="" srcset="" className="card_icon" />
                                                    </div>

                                                </div>
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">Company Name</p>
                                        ...
                                        {/* money */}
                                        <div className="col-2">
                                            <div className="card_body_icon border rounded mb-5 ">
                                                <div className="pt-5  d-flex justify-content-center">
                                                ...
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">Price</p>
                                        ...
                                        <div className="col-2">
                                            <div className="card_body_icon border rounded mb-5">
                                                ...
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">Car Name</p>
                                        ...
                                        <div className="col-2">
                                            <div className="card_body_icon border rounded mb-5">
                                                ...
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">Peak Power</p>
                                        ...
                                        <div className="col-2">
                                            <div className="card_body_icon border rounded mb-5">
                                                ...
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">Registration Year</p>
                                        ...
                                        <div className="col-2">
                                            <div className="card_body_icon border rounded mb-5">
                                                ...
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">Doors</p>
                                        ...
                                        <div className="col-2">
                                            <div className="card_body_icon border rounded mb-5">
                                                ...
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">Engine</p>
                                        ...
                                        <div className="col-2">
                                            <div className="card_body_icon border rounded mb-5">
                                                ...
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">Fuel Type</p>
                                        ...
                                        <div className="col-2">
                                            <div className="card_body_icon border rounded mb-5">
                                                ...
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">Vehicle Type</p>
                                        ...
                                        <div className="col-2">
                                            <div className="card_body_icon border rounded mb-5">
                                                ...
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">style</p>
                                        ...
                                        <div className="col-2">
                                            <div className="card_body_icon border rounded mb-5">
                                                ...
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">Ownership</p>
                                        ...
                                        <div className="col-2">
                                            <div className="card_body_icon border rounded mb-5">
                                                ...
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">Seating Capacity</p>
                                        ...
                                        <div className="col-2">
                                            <div className="card_body_icon border rounded mb-5">
                                                ...
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">Drive</p>
                                        ...
                                        <div className="col-2">
                                            <div className="card_body_icon border rounded mb-5">
                                                ...
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">KMS done</p>
                                        ...
                                        <div className="col-2">
                                            <div className="card_body_icon border rounded mb-5">
                                                ...
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">Interior Color</p>
                                        ...
                                        <div className="col-2">
                                            <div className="card_body_icon border rounded mb-5">
                                                ...
                                                <div className="card_text">
                                                    <p className=" text-center pt-3 bor_set_tex m-0">External Color</p>
