...
import lexus_top from '../../assets/lexus_top.jpg'
        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>LEXUS INDIA</h1>
                    <h4 className='text-center'>"THE RELENTLESS PURSUIT OF PERFECTION"</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={lexus_top} alt="" className='img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container'>
                        <p className='text-start p-5'>Power. Beauty. Soul</p>
                        <h4 className='text-center'>LEXUS <span className='text-danger bold'>CARS</span></h4>
