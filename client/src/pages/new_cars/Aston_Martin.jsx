...
import Aston_martin_top from '../../assets/Aston_martin_top.jpg'
import './all_cars.css'
import Explore_body from '../explore/explore_body.jsx'
import { Link } from 'react-router-dom'
// import { userCartcontaxt } from '../../component/cart/cart_context.jsx';
// import { createContext, useContext, useReducer, } from "react";
import { useNavigate } from 'react-router-dom'


function Aston_matin() {
        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>ASTON MARTIN INDIA</h1>
                    <h4 className='text-center'>"POWER. BEAUTY. SOUL"</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={Aston_martin_top} alt="" srcset="" className='  img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container '>
                        <p className='text-start p-5'>Power. Beauty. Soul</p>
                        <h4 className='text-center'>ASTON MARTIN <span className='text-danger bold'>CARS</span></h4>
