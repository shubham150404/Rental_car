...
import jeep_top from '../../assets/jeep_top.jpg'
    ...
    return (
        ...
        <div className=' position-relative top-0'>
            <div className='txt_hd_set '>
                <h1 className='text-center p-2 pt-5'>JEEP INDIA</h1>
                <h4 className='text-center'>GO ANYWHERE. DO ANYTHING.</h4>
            </div>
            <div className='mclaren_top'>
                <img src={jeep_top} alt="" className='  img-fluid' />
            </div>
            <div className='exf2'>
                <div className='container'>
                    <p className='text-start p-5'> It required very little input from drivers to conquer any path less-traveled.</p>
                    <h4 className='text-center'>JEEP  <span className='text-danger bold'>CARS</span></h4>
