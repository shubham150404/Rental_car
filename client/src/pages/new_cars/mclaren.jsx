        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>MCLAREN INDIA</h1>
                    <h4 className='text-center'>"THERE IS NO FINISH LINE"</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={Mclaren_top} alt="" srcset="" className='  img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container'>
                        ...
                        <h1 className='text-center'>MCLAREN <span className='text-danger bold'>CARS</span></h1>
