...
import Ferrari_top from '../../assets/Ferrari_top.jpg'
        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>FERRARI INDIA</h1>
                    <h4 className='text-center'>ONLY THOSE WHO DARE, TRULY LIVE</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={Ferrari_top} alt="" className='img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container'>
                        <p className='text-start p-5'>Only those who dare, truly live.</p>
                        <h4 className='text-center'>FERRARI<span className='text-danger bold'>CARS</span></h4>
