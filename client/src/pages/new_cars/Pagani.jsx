...
import Pagani_top from '../../assets/Pagani_top.jpg'
        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>PAGANI INDIA</h1>
                    <h4 className='text-center'>"THE CAR ATELIER SURPASSES TIME, LIKE AN UNRELENTING WIND."</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={Pagani_top} alt="" className='img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container'>
                        <p className='text-start p-5'>The car atelier surpasses time, like an unrelenting wind.</p>
                        <h4 className='text-center'>PAGANI  <span className='text-danger bold'>CARS</span></h4>
