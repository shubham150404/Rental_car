...
import Porsche_top from '../../assets/Porsche_top.jpg'
        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>PORSCHE INDIA</h1>
                    <h4 className='text-center'>"FULL SPECTRUM – FULL SYNERGY"</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={Porsche_top} alt="" className='img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container'>
                        <p className='text-start p-5'>Porsche AG offers all services for technical vehicle developments and related areas.</p>
                        <h4 className='text-center'>PORSCHE <span className='text-danger bold'>CARS</span></h4>
