...
import Bugatti_top from '../../assets/Bugatti_top.jpg'
import './all_cars.css'
        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>BUGATTI INDIA</h1>
                    <h4 className='text-center'>"THE ART OF BUGATTI"</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={Bugatti_top} alt="" srcset="" className='  img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container'>
                        <p className='text-start p-5'>v</p>
                        <h4 className='text-center'>BUGATTI <span className='text-danger bold'>CARS</span></h4>
