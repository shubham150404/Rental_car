...
import Land_Rover_top from '../../assets/Land_Rover_top.jpg'
        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>LAND ROVER INDIA</h1>
                    <h4 className='text-center'>"ABOVE & BEYOND"</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={Land_Rover_top} alt="" className='img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container'>
                        <p className='text-start p-5'>Land Rover has always promoted its ability to go anywhere and do anything.</p>
                        <h4 className='text-center'>LAND ROVER<span className='text-danger bold'>CARS</span></h4>
