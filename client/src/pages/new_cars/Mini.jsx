...
import Mini_top from '../../assets/Mini_top.jpg'
        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>MINI INDIA</h1>
                    <h4 className='text-center'>"YOU DON’T NEED A BIG ONE TO BE HAPPY."</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={Mini_top} alt="" className='  img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container'>
                        <p className='text-start p-5'>Maximize the experience while focusing on the essential.</p>
                        <h4 className='text-center'>MINI COOPER <span className='text-danger bold'>CARS</span></h4>
