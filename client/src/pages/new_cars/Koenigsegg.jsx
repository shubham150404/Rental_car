...
import Koenigsegg_top from '../../assets/Koenigsegg_top.jpg'
        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>KOENIGSEGG INDIA</h1>
                    <h4 className='text-center'>"THE SPIRIT OF PERFORMANCE"</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={Koenigsegg_top} alt="" className='img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container'>
                        <p className='text-start p-5'>This is our tradition and commitment, that has made the company we are today. The Koenigsegg way. The Spirit of Performance.</p>
                        <h4 className='text-center'>KOENIGSEGG  <span className='text-danger bold'>CARS</span></h4>
