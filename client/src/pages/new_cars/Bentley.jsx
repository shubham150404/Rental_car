...
import Bentley_top from '../../assets/Bentley_top.jpg'
import './all_cars.css'
            ...
            <div>
                ...
                <div className=' position-relative top-0'>
                    <div className='txt_hd_set '>
                        <h1 className='text-center p-2 pt-5'>BENTLEY INDIA</h1>
                        <h4 className='text-center'>"THE SILENT SPORTS CAR"</h4>
                    </div>
                    <div className='mclaren_top'>
                        <img src={Bentley_top} alt="" srcset="" className='  img-fluid' />
                    </div>
                    <div className='exf2'>
                        <div className='container'>
                            <p className='text-start p-5'>The Silent Sports Car</p>
                            <h4 className='text-center'>BENTLEY<span className='text-danger bold'>CARS</span></h4>
