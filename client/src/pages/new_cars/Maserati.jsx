...
import Maserati_top from '../../assets/Maserati_top.jpg'
        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>MASERATI INDIA</h1>
                    <h4 className='text-center'>"LUXURY, SPORTS, AND STYLE CAST IN EXCLUSIVE CARS"</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={Maserati_top} alt="" className='  img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container'>
                        <p className='text-start p-5'>Luxury, sports, and style cast in exclusive cars.</p>
                        <h4 className='text-center'>MASERATI <span className='text-danger bold'>CARS</span></h4>
