...
import Rolls_top from '../../assets/Rolls_top.jpg'
        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>ROLLS ROYCE INDIA</h1>
                    <h4 className='text-center'>"TRUSTED TO DELIVER EXCELLENCE"</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={Rolls_top} alt="" className='img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container'>
                        <p className='text-start p-5'>Trusted To Deliver Excellence</p>
                        <h4 className='text-center'>ROLLS ROYCE <span className='text-danger bold'>CARS</span></h4>
