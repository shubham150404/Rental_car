...
import Mercedes_top from '../../assets/Mercedes_top.jpg'
        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>MERCEDES-BENZ INDIA</h1>
                    <h4 className='text-center'>"THE BEST OR NOTHING"</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={Mercedes_top} alt="" className='img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container'>
                        <p className='text-start p-5'>Mercedes-Benz is both a German automotive marque and, from late 2019 onwards, a subsidiary of Daimler AG.  The headquarters is in Stuttgart, Baden-Württemberg.</p>
                        <h4 className='text-center'>MERCEDES-BENZ <span className='text-danger bold'>CARS</span></h4>
