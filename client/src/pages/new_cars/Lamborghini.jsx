...
import Laborghini_top from '../../assets/Laborghini_top.jpg'
        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>LAMBORGHINI INDIA</h1>
                    <h4 className='text-center'>"WE ARE NOT SUPERCARS. WE ARE LAMBORGHINI."</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={Laborghini_top} alt="" className='img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container'>
                        <p className='text-start p-5'>Power. Beauty. Soul</p>
                        <h4 className='text-center'>LAMBORGHINI  <span className='text-danger bold'>CARS</span></h4>
