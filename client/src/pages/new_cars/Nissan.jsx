...
import Nisan_top from '../../assets/Nisan_top.jpg'
        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>NISSAN INDIA</h1>
                    <h4 className='text-center'>"INNOVATION THAT EXCITES"</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={Nisan_top} alt="" className='img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container'>
                        <p className='text-start p-5'>There is no finish line is used in an inspirational context: our work is never done. There's always a further, to which we can push things.</p>
                        <h4 className='text-center'>NISSAN  <span className='text-danger bold'>CARS</span></h4>
