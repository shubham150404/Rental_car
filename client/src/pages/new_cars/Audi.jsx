...
import Audi_top from '../../assets/Audi_top.jpg'
            ...
            <div>
                ...
                <div className='position-relative top-0'>
                    <div className='txt_hd_set '>
                        <h1 className='text-center p-2 pt-5'>AUDI INDIA</h1>
                        <h4 className='text-center'>"BEING AHEAD THROUGH TECHNOLOGY"</h4>
                    </div>
                    <div className='mclaren_top'>
                        <img src={Audi_top} alt="" srcset="" className='  img-fluid' />
                    </div>
                    <div className='exf2'>
                        <div className='container'>
                            <p className='text-start p-5'>German luxury automobile manufacturer Audi was founded in the year 1909. The company has its headquarters located in Ingolstadt. Audi India, founded in 2007, is a division of the Volkswagen Group India with its headquarters located in Mumbai.</p>
                            <h4 className='text-center'>AUDI <span className='text-danger bold'>CARS</span></h4>
