...
import volvo_top from '../../assets/volvo_top.jpg'
        ...
        <div>
            ...
            <div className=' position-relative top-0'>
                <div className='txt_hd_set '>
                    <h1 className='text-center p-2 pt-5'>VOLVO INDIA</h1>
                    <h4 className='text-center'>"VOLVO YOUR LIFE"</h4>
                </div>
                <div className='mclaren_top'>
                    <img src={volvo_top} alt="" className='img-fluid' />
                </div>
                <div className='exf2'>
                    <div className='container'>
                        <p className='text-start p-5'>Life, it not only means one's life beings but also how we live, the quality of our lives. So safety is the core idea of Volvo Cars. </p>
                        <h4 className='text-center'>VOLVO  <span className='text-danger bold'>CARS</span></h4>
