    ...
    const handlesubmits = (s) => {
        try {
            ...
            if (!inputData.registration_year?.trim()) {
                validationError.registration_year = "registration_year Type is require"
            }
            if (!inputData.Vehicle_Type?.trim()) {
                validationError.Vehicle_Type = "Vehicle Type is require"
            }
            ...
            if(!inputData.photos){
                validationError.photos = "image is require"
            }
            if (!inputData.Ownership?.trim()) {
                validationError.Ownership = "Ownership  is require"
            }
            if (!inputData.style?.trim()) {
                validationError.style = "style  is require"
            }
            ...
            axios.post('http://localhost:3000/new_car_create', formData)
            ...
            <div className=' p-0 m-0 '>
                <div className='d-flex saibar_set'>
                    ...
                    <div className='col-10 '>
                        <h1 className='p-5'>Add new car's</h1>
                            ...
                            <form className='add-details py-3 shado_set f2_'>
                                <div className='d-flex justify-content-around pb-3'>
                                    <div className="px-3 ">
                                        ...
                                        <input onChange={handleinputs} value={inputData.name} type="text" className="form-control" name='name' id="exampleInputEmail1" aria-describedby="emailHelp" autoComplete='off' />
                                        {errors.name && <span className='text-danger seterror'>***{errors.name}***</span>}

                                    </div>
                                    <div className="px-3  ">
                                        <label className="form-label">Price</label>
                                        <input type="number" name='price' className="form-control" id="exampleInputname1" aria-describedby="emailHelp" autoComplete='off' value={inputData.price} onChange={handleinputs} />
                                ...
                                <div className='d-flex justify-content-around pb-3'>
                                    ...
                                    <div className="px-3 ">
                                        ...
                                        <input onChange={(e) => setSelectedFile(e.target.files[0])} type="file" className="form-control" name='photos' id="exampleInputEmail1" aria-describedby="emailHelp" autoComplete='off' />
                                        {errors.photos && <span className='text-danger seterror'>***{errors.photos}***</span>}
                                ...
                                <div className='d-flex justify-content-around pb-3'>
                                    ...
                                    <div className="px-3 ">
                                        ...
                                        <input onChange={handleinputs} value={inputData.Pickup_power} type="number" className="form-control" name='Pickup_power' id="exampleInputEmail1" aria-describedby="emailHelp" autoComplete='off' />
                                ...
                                <div className='d-flex justify-content-around pb-3'>
                                    ...
                                    <div className="px-3  ">
                                        ...
                                        <input onChange={handleinputs} value={inputData.style} type="text" name='style' className="form-control" id="exampleInputname1" aria-describedby="emailHelp" autoComplete='off' />
                                        {errors.style && <span className='text-danger seterror'>***{errors.style}***</span>}
